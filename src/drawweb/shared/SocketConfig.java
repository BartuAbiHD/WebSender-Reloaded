...
public class SocketConfig
{
    ...
    public static boolean isBukkit() {
        return SocketConfig.status != null && SocketConfig.status.equals("Bukkit");
    }
    
    public static boolean isBungee() {
        return SocketConfig.status != null && SocketConfig.status.equals("BungeeCord");
    }
}
